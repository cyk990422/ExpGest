...
def pose2json(bvh_file):
    ...
    np.savez("./audio_only_smplx.npz",poses=smplx_aa*0.0,trans=transl*0.01,betas=np.zeros(10),gender='male',mocap_framerate=30,)
...
if __name__ == '__main__':
    animation_file = '/apdcephfs/share_1290939/shaolihuang/ykcheng/SIGDG_zeroegg_siggraph2024/demo-csig/t2/t2_wavlm_90W_zeroegg_didiffges_seed2.bvh'
    ...
    smplx_fitting_aa = np.load("/apdcephfs/share_1290939/shaolihuang/ykcheng/DiffCoSG/new3/ExpGes_demo/remote_down_dir/t2_wavlm_90W_zeroegg_didiffges_seed2.npz")['poses']
    transl = np.load("/apdcephfs/share_1290939/shaolihuang/ykcheng/DiffCoSG/new3/ExpGes_demo/remote_down_dir/t2_wavlm_90W_zeroegg_didiffges_seed2.npz")['trans']
