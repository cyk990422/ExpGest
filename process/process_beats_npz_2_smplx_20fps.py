...
class PCG():
    ...
    def export(self, poses, trans, face=None, wrist='hand', protocol='gilly', frame_id=None):
        ...
        if wrist == 'hand':
            ...
            quat[15][0],quat[15][1],quat[15][2],quat[15][3]=quat[15][0],quat[15][1]-1,quat[15][2],quat[15][3]-0.16
...
def main():
    ...
    # GT
    data = np.load('/apdcephfs/share_1290939/shaolihuang/ykcheng/DiffCoSG/new3/ExpGes_demo/demo/main/process/beat_zyx_quat.npy')
    all_trans = np.load('/apdcephfs/share_1290939/shaolihuang/ykcheng/DiffCoSG/new3/ExpGes_demo/demo/main/process/beat_zyx_transl.npy')
...
if __name__ == '__main__':
    # npz_path = "/apdcephfs/share_1290939/shaolihuang/ykcheng/DiffCoSG/new3/ExpGes_demo/demo/main/mydiffusion_zeggs/our_gen_text.npz"
    npz_path = "/apdcephfs/share_1290939/shaolihuang/ykcheng/SIGASIA_realtime_A2G/HoloGest/HoloGest_audio2gesture/main/mydiffusion_zeggs/beat2_our_rot_cvt_allposw.npz"
    data=np.load(npz_path,allow_pickle=True)
